...
export type User =
  | ({
      userPreferences: {
        id: string;
        userId: string;
        draftRoundDuration: number;
        cardsPerRound: number;
        subsExtraVote: boolean;
        botJoinsChannel: boolean;
        snapFanApiKey: string | null;
      ...
      twitchProfilePictureURL: string | null;
...
export async function updateUserSetupCompleteStatus(
  prisma: PrismaClient,
  username: string,
  isComplete: boolean
) {

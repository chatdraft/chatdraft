				...
				<div class="relative group-hover:outline outline-1 outline-offset-4 outline-white card m-2">
					<a href="https://www.twitch.tv/{draft.channel}" target="_blank" class="anchor w-full">
						...
						<iconify-icon
							...
							width="24"
							height="24"
							class="absolute -top-1 -right-1 invisible group-hover:visible group-focus:visible"
						/>
						<p
							class="absolute top-4 left-4 font-bold text-4xl font-outline font-outline-black text-white font-snapa uppercase truncate w-64 text-center backdrop-blur-md bg-white/30 rounded-md"
						>
							{draft.channel}
						</p>
						<div

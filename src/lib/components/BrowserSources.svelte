...
<div class="card mt-4 ml-8 p-2">
    {#if !splitView}
        ...
        <a class="btn btn-sm variant-filled-secondary browser-drag-item cursor-move w-min m-2" on:click|preventDefault draggable="true" href="{`${$page.url.origin}/stream/${user}?layer-name=Oro%20Chat%20Draft&layer-height=640&layer-width=1080`}">
    ...
    {:else}
        ...
        <a class="btn btn-sm variant-filled-secondary browser-drag-item cursor-move w-min m-2" on:click|preventDefault draggable="true" href="{`${$page.url.origin}/stream/${user}?hide=choice&layer-name=Oro%20Chat%20Draft%20Deck&layer-height=410&layer-width=500`}">

...
<p class="mt-4">
  The chat draft overlay is provided via browser source. The overlay has been
  designed pseudo responsive and will appear differently at different
  resolutions. Additionally, the overlay can be presented as combined (simple)
  or separate (advanced).
</p>
    ...
    <div class="card p-2">
      {#if tabSet === 0}
        <BrowserSourceComponent
          ...
          height={940}
          width={470}>
          TODO: insert Screenshot of Options & Deck and recommended browser
          resolution
        </BrowserSourceComponent>
      {:else if tabSet === 1}
        <BrowserSourceComponent
          ...
          height={420}
          width={470}>
          TODO: insert Screenshot of Options only and recommended browser
          resolution
        </BrowserSourceComponent>
      {:else if tabSet === 2}
        <BrowserSourceComponent
          ...
          height={580}
          width={470}>
          TODO: insert Screenshot of Deck only and recommended browser
          resolution
        </BrowserSourceComponent>
      {/if}
    </div>
...
<div class="m-4">
  ...
  <p class="mt-2">
    When a draft is not active, the browser sources will be completely
    transparent. Preview mode fills the browser sources with an example draft.

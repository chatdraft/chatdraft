...
<br/>
<input bind:this={collectionFile} name="collection" class="mt-2 input w-1/4" type="file" accept=".json">
<br/>
<button class="btn btn-md variant-filled-primary mt-2" on:click={Submit}>Upload Collection</button>
